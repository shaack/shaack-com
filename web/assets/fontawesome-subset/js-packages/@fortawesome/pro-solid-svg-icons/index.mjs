...
export { icons as fas, prefix, faRightFromBracket, faSignOutAlt, faBars, faNavicon, faLock, faShieldCheck, faRightToBracket, faSignInAlt, faChessKnight, faUnlock, faAddressCard, faContactCard, faVcard, faLanguage, faBadgeCheck, faXmarkLarge, faXmark, faClose, faMultiply, faRemove, faTimes, faThumbsUp, faNotdef };
